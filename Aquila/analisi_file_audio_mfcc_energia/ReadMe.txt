========================================================================
    APPLICAZIONE CONSOLE: cenni preliminari sul progetto analisi_file_audio_mfcc_energia
========================================================================

La creazione guidata applicazione ha creato questa applicazione analisi_file_audio_mfcc_energia.

Questo file contiene un riepilogo del contenuto di ciascun file che fa parte
dell'applicazione analisi_file_audio_mfcc_energia.


analisi_file_audio_mfcc_energia.vcxproj
...
analisi_file_audio_mfcc_energia.vcxproj.filters
...
analisi_file_audio_mfcc_energia.cpp
...
StdAfx.h, StdAfx.cpp
    Tali file vengono utilizzati per generare il file di intestazione precompilato analisi_file_audio_mfcc_energia.pch e il file dei tipi precompilato StdAfx.obj.
