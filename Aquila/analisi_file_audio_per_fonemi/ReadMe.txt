========================================================================
    APPLICAZIONE CONSOLE: cenni preliminari sul progetto analisi_file_audio_per_fonemi
========================================================================

La creazione guidata applicazione ha creato questa applicazione analisi_file_audio_per_fonemi.

Questo file contiene un riepilogo del contenuto di ciascun file che fa parte
dell'applicazione analisi_file_audio_per_fonemi.


analisi_file_audio_per_fonemi.vcxproj
...
analisi_file_audio_per_fonemi.vcxproj.filters
...
analisi_file_audio_per_fonemi.cpp
...
StdAfx.h, StdAfx.cpp
    Tali file vengono utilizzati per generare il file di intestazione precompilato analisi_file_audio_per_fonemi.pch e il file dei tipi precompilato StdAfx.obj.
