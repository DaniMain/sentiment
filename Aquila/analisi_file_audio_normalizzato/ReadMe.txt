========================================================================
    APPLICAZIONE CONSOLE: cenni preliminari sul progetto analisi_file_audio_normalizzato
========================================================================

La creazione guidata applicazione ha creato questa applicazione analisi_file_audio_normalizzato.

Questo file contiene un riepilogo del contenuto di ciascun file che fa parte
dell'applicazione analisi_file_audio_normalizzato.


analisi_file_audio_normalizzato.vcxproj
...
analisi_file_audio_normalizzato.vcxproj.filters
...
analisi_file_audio_normalizzato.cpp
...
StdAfx.h, StdAfx.cpp
    Tali file vengono utilizzati per generare il file di intestazione precompilato analisi_file_audio_normalizzato.pch e il file dei tipi precompilato StdAfx.obj.
