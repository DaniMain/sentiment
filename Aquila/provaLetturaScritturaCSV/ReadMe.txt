========================================================================
    APPLICAZIONE CONSOLE: cenni preliminari sul progetto provaLetturaScritturaCSV
========================================================================

La creazione guidata applicazione ha creato questa applicazione provaLetturaScritturaCSV.

Questo file contiene un riepilogo del contenuto di ciascun file che fa parte
dell'applicazione provaLetturaScritturaCSV.


provaLetturaScritturaCSV.vcxproj
...
provaLetturaScritturaCSV.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Tali file vengono utilizzati per generare il file di intestazione precompilato provaLetturaScritturaCSV.pch e il file dei tipi precompilato StdAfx.obj.
