========================================================================
    APPLICAZIONE CONSOLE: cenni preliminari sul progetto analisi_file_audio_noIO
========================================================================

La creazione guidata applicazione ha creato questa applicazione analisi_file_audio_noIO.

Questo file contiene un riepilogo del contenuto di ciascun file che fa parte
dell'applicazione analisi_file_audio_noIO.


analisi_file_audio_noIO.vcxproj
...
analisi_file_audio_noIO.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Tali file vengono utilizzati per generare il file di intestazione precompilato analisi_file_audio_noIO.pch e il file dei tipi precompilato StdAfx.obj.
