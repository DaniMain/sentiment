========================================================================
    APPLICAZIONE CONSOLE: cenni preliminari sul progetto analisi_file_audio_media_e_normalizzazione
========================================================================

La creazione guidata applicazione ha creato questa applicazione analisi_file_audio_media_e_normalizzazione.

Questo file contiene un riepilogo del contenuto di ciascun file che fa parte
dell'applicazione analisi_file_audio_media_e_normalizzazione.


analisi_file_audio_media_e_normalizzazione.vcxproj
...
analisi_file_audio_media_e_normalizzazione.vcxproj.filters
...
analisi_file_audio_media_e_normalizzazione.cpp
...
StdAfx.h, StdAfx.cpp
    Tali file vengono utilizzati per generare il file di intestazione precompilato analisi_file_audio_media_e_normalizzazione.pch e il file dei tipi precompilato StdAfx.obj.
