========================================================================
    APPLICAZIONE CONSOLE: cenni preliminari sul progetto analisi_file_audio_classificazioneNumerica
========================================================================

La creazione guidata applicazione ha creato questa applicazione analisi_file_audio_classificazioneNumerica.

Questo file contiene un riepilogo del contenuto di ciascun file che fa parte
dell'applicazione analisi_file_audio_classificazioneNumerica.


analisi_file_audio_classificazioneNumerica.vcxproj
...
analisi_file_audio_classificazioneNumerica.vcxproj.filters
...
analisi_file_audio_classificazioneNumerica.cpp
...
StdAfx.h, StdAfx.cpp
    Tali file vengono utilizzati per generare il file di intestazione precompilato analisi_file_audio_classificazioneNumerica.pch e il file dei tipi precompilato StdAfx.obj.
